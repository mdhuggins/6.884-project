...
class LitBertInputModel2(pl.LightningModule):
    @staticmethod
    def col_fn(x):
    ...
    def training_step(self, batch, batch_idx):
        ...
        q_inputs_embeds = self.get_and_infuse_knowledge(query_dict['input_ids'])
        out = self.bert(inputs_embeds=q_inputs_embeds,
        ...
        r_inputs_embeds=self.get_and_infuse_knowledge(response_dict['input_ids'])
        out = self.bert(inputs_embeds=r_inputs_embeds,
