...
if __name__ == '__main__':
    ...
    d = pickle.load(open("/Users/pedro/Documents/Documents - Pedro’s MacBook Pro/git/6.884-project/numberbatch.h5","rb"))
    print("Total keys", len(d))

    def get_matcher(embedding_map):
        matcher = get_phrase_matcher(numberbatch=embedding_map, nlp=nlp)
        return matcher
    matcher1 = get_matcher(d)
